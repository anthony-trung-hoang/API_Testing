...
public class GetListAuctionsTests {
	...
	// int statusId, String user_id,String type, String category_id, int index, int
	// count, String token
	...
	public void unitTest20() {
		this.setToken();
		System.out.println("Code should not be 1000 and message should not be OK with negative input (3 null)");
		System.out.println("Testing unit20...");
		getListAuctions.Test07(2, "", "", "", -1, -10, null);
		Assertions.assertNotEquals(1000, getListAuctions.getCode());
		Assertions.assertNotEquals("OK", getListAuctions.getMessage());
		System.out.println("Unit 4: Satisfied");

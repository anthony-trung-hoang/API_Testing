...
class EditAccountTest {
    ...
    public void UnitTest01(){
    	login.Test03("dien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "dien1@gmail.com", "hanoi" , "dien", "0123456789", null);
    ...
    public void UnitTest02(){
    	login.Test03("dien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "dien1@gmail.com", "hanoi" , 
    ...
    public void UnitTest03(){
    	login.Test03("dien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "dien1@gmail.com", "hanoi" , "", "0123456789", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest04(){
    	login.Test03("dien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "thanh12345@gmail.com", "hanoi" , "dien", "0123456789", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest05(){
    	login.Test03("dien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "dien1", "hanoi" , "dien", "0123456789", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest06(){
    	login.Test03("dien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "dien1kffggggfkgkflsslgfabcdefghiklmnopqrstuvwxyzabcdefghiklmnopqrstuvwxyzabcdefghiklmnopqrstuvwxyzabcdefghiklmnopqrstuvwxyzabcdef"
				+ "ghiklmnopqrstuvwxyzabcdefghiklmnopqrstuvwxyzabcdefghiklmnopqrstuvwxyzabcdefghiklmnopqrstuvwxyzabcdefghiklmnopqrstuvwxyz"
				+ "abcdefghiklmnopqrstuvwxyzabcdefghiklmnopqrstuvwxyzabcdefghiklmnopqrstuvwxyzabcdefghiklmnopqrstuvwxyzabcdefghiklmnopqrstuvwxyz"
    ...
    public void UnitTest07(){
    	login.Test03("dien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "", "hanoi" , "dien", "0123456789", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest08(){
    	login.Test03("tdien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "tdien1@gmail.com", "hanoi" , "dien", "0123456789012345678901234567890123456789012345678901234567890123456789", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest09(){
    	login.Test03("tdien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "tdien1@gmail.com", "hanoi" , "dien", "", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest10(){
    	login.Test03("tdien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "tdien1@gmail.com", 

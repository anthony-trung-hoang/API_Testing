...
class EditAccountTest {
    ...
    public void UnitTest02(){
        ...
        editAccount.Test05( login.getToken(), "dien1@gmail.com", "123456", "123456", "hanoi" ,
    ...
    public void UnitTest03(){
        login.Test01("dien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "dien1@gmail.com", "123456", "123456", "hanoi" , "", "0123456789", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest04(){
        login.Test01("dien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "thanh12345@gmail.com", "123456", "123456", "hanoi" , "dien", "0123456789", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest05(){
        login.Test01("dien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "dien1", "123456", "123456", "hanoi" , "dien", "0123456789", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest07(){
        login.Test01("dien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "", "123456", "123456", "hanoi" , "dien", "0123456789", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest08(){
        ...
        editAccount.Test05( login.getToken(), "tdien1@gmail.com", "123456", "123456", "hanoi" , "dien", "0123456789012345678901234567890123456789012345678901234567890123456789", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest09(){
        login.Test01("tdien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "tdien1@gmail.com", "123456", "123456", "hanoi" , "dien", "", null);
        Assertions.assertEquals(1001,editAccount.getCode());
    ...
    public void UnitTest10(){
        login.Test01("tdien1@gmail.com", "123456");
        editAccount.Test05( login.getToken(), "tdien1@gmail.com", "123456", "123456",
